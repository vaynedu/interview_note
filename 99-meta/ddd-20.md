...
## <a id="q6"></a>6. 聚合根的职责？为什么外部只能引用聚合根？
...
## <a id="q13"></a>13. 六边形架构 vs 整洁架构 vs 洋葱？
...
## <a id="q14"></a>14. CQRS 适合什么场景？一定要用 ES 吗？
...
## <a id="q16"></a>16. Saga 长事务怎么实现？编舞 vs 编排？
...
## <a id="q20"></a>20. DDD 项目目录怎么组织？Repository 接口放哪？
