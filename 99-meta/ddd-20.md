...
1. [DDD 是什么？解决什么问题？](#1-ddd-是什么解决什么问题)
2. [什么是限界上下文？怎么划分？](#2-什么是限界上下文怎么划分)
3. [通用语言为什么重要？](#3-通用语言为什么重要)
4. [核心域 / 支撑域 / 通用域怎么区分？](#4-核心域--支撑域--通用域怎么区分)
5. [实体 vs 值对象怎么区分？](#5-实体-vs-值对象怎么区分)
6. [聚合根的职责？为什么外部只能引用聚合根？](#6-聚合根的职责为什么外部只能引用聚合根)
7. [一个事务为什么只改一个聚合？](#7-一个事务为什么只改一个聚合)
8. [跨聚合怎么引用？](#8-跨聚合怎么引用)
9. [仓储 vs DAO 区别？](#9-仓储-vs-dao-区别)
10. [领域服务 vs 应用服务区别？](#10-领域服务-vs-应用服务区别)
11. [领域事件 vs 集成事件？](#11-领域事件-vs-集成事件)
12. [什么是防腐层？什么时候用？](#12-什么是防腐层什么时候用)
13. [六边形架构 vs 整洁架构 vs 洋葱？](#13-六边形架构-vs-整洁架构-vs-洋葱)
14. [CQRS 适合什么场景？一定要用 ES 吗？](#14-cqrs-适合什么场景一定要用-es-吗)
15. [事件溯源（ES）的优劣？](#15-事件溯源es的优劣)
16. [Saga 长事务怎么实现？编舞 vs 编排？](#16-saga-长事务怎么实现编舞-vs-编排)
17. [Outbox 模式解决什么？](#17-outbox-模式解决什么)
18. [DDD 和微服务什么关系？](#18-ddd-和微服务什么关系)
19. [贫血模型 vs 充血模型？](#19-贫血模型-vs-充血模型)
20. [DDD 项目目录怎么组织？Repository 接口放哪？](#20-ddd-项目目录怎么组织repository-接口放哪)
