...
1. [Code Review 看什么？](#1-code-review-看什么)
2. [CR 反馈怎么分级？](#2-cr-反馈怎么分级)
3. [PR 应该多大？怎么写好 PR 描述？](#3-pr-应该多大怎么写好-pr-描述)
4. [Go 命名规范？](#4-go-命名规范)
5. [错误码怎么设计？](#5-错误码怎么设计)
6. [RESTful API 设计要点？](#6-restful-api-设计要点)
7. [Protobuf 兼容性铁律？](#7-protobuf-兼容性铁律)
8. [测试金字塔是什么？](#8-测试金字塔是什么)
9. [FIRST 原则？AAA 结构？](#9-first-原则aaa-结构)
10. [Mock vs Stub vs Fake？](#10-mock-vs-stub-vs-fake)
11. [Table-Driven Tests 优势？](#11-table-driven-tests-优势)
12. [覆盖率多少合理？](#12-覆盖率多少合理)
13. [可观测性三支柱？](#13-可观测性三支柱)
14. [OpenTelemetry 是什么？](#14-opentelemetry-是什么)
15. [trace_id 怎么全链路透传？](#15-trace_id-怎么全链路透传)
16. [Prometheus label 怎么设计？](#16-prometheus-label-怎么设计)
17. [/healthz vs /ready 区别？](#17-healthz-vs-ready-区别)
18. [怎么优雅关闭服务？](#18-怎么优雅关闭服务)
19. [线上接口超时怎么排查？](#19-线上接口超时怎么排查)
20. [发布质量怎么保证？](#20-发布质量怎么保证)
