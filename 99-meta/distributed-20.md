...
1. [CAP 怎么理解？为什么不能三选三？](#1-cap-怎么理解为什么不能三选三)
2. [BASE 是什么？](#2-base-是什么)
3. [Paxos / Raft / ZAB / Gossip 区别？](#3-paxos--raft--zab--gossip-区别)
4. [Raft 怎么选举？怎么保一致性？](#4-raft-怎么选举怎么保一致性)
5. [2PC / 3PC 区别？为什么 3PC 不靠谱？](#5-2pc--3pc-区别为什么-3pc-不靠谱)
6. [TCC 是什么？什么时候用？](#6-tcc-是什么什么时候用)
7. [Saga 怎么实现？](#7-saga-怎么实现)
8. [本地消息表 / Outbox 模式？](#8-本地消息表--outbox-模式)
9. [分布式锁选型：Redis / ZK / etcd？](#9-分布式锁选型redis--zk--etcd)
10. [Redlock 真的安全吗？fencing token？](#10-redlock-真的安全吗fencing-token)
11. [雪花算法 vs 号段 vs UUID？](#11-雪花算法-vs-号段-vs-uuid)
12. [限流算法：固定窗口 / 滑动窗口 / 令牌桶 / 漏桶？](#12-限流算法固定窗口--滑动窗口--令牌桶--漏桶)
13. [熔断器状态机？](#13-熔断器状态机)
14. [降级 / 限流 / 熔断怎么配合？](#14-降级--限流--熔断怎么配合)
15. [服务发现 CP 还是 AP？](#15-服务发现-cp-还是-ap)
16. [负载均衡算法？P2C 是什么？](#16-负载均衡算法p2c-是什么)
17. [一致性 Hash 原理？虚拟节点？](#17-一致性-hash-原理虚拟节点)
18. [幂等性怎么实现？](#18-幂等性怎么实现)
19. [Snowflake 时钟回拨怎么处理？](#19-snowflake-时钟回拨怎么处理)
20. [分布式系统怎么保证一致性？](#20-分布式系统怎么保证一致性)
...
## 10. Redlock 真的安全吗？fencing token？
