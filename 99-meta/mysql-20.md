...
2. [InnoDB vs MyISAM？](#2-innodb-vs-myisam)
3. [B+ 树索引为什么用 B+ 不用 B / 红黑树 / Hash？](#3-b-树索引为什么用-b-不用-b--红黑树--hash)
4. [聚簇索引 vs 二级索引？回表是什么？](#4-聚簇索引-vs-二级索引回表是什么)
5. [覆盖索引 / 最左前缀 / 索引下推？](#5-覆盖索引--最左前缀--索引下推)
6. [事务隔离级别？幻读怎么解？](#6-事务隔离级别幻读怎么解)
7. [MVCC 原理？快照读 vs 当前读？](#7-mvcc-原理快照读-vs-当前读)
8. [行锁 / 间隙锁 / Next-Key Lock？](#8-行锁--间隙锁--next-key-lock)
9. [死锁怎么排查？](#9-死锁怎么排查)
10. [redo log / undo log / binlog 区别？](#10-redo-log--undo-log--binlog-区别)
11. [两阶段提交？为什么需要？](#11-两阶段提交为什么需要)
12. [主从复制原理？延迟怎么处理？](#12-主从复制原理延迟怎么处理)
13. [半同步复制 vs 异步复制 vs 全同步？](#13-半同步复制-vs-异步复制-vs-全同步)
14. [慢 SQL 怎么排查和优化？](#14-慢-sql-怎么排查和优化)
15. [explain 关键字段？type / key / Extra？](#15-explain-关键字段type--key--extra)
16. [InnoDB Buffer Pool 是什么？](#16-innodb-buffer-pool-是什么)
17. [Online DDL / MDL 锁？大表加字段怎么做？](#17-online-ddl--mdl-锁大表加字段怎么做)
18. [分库分表怎么做？跨库 join 怎么解？](#18-分库分表怎么做跨库-join-怎么解)
19. [分布式 ID 方案对比？](#19-分布式-id-方案对比)
20. [线上数据一致性怎么对账？](#20-线上数据一致性怎么对账)
...
## 10. redo log / undo log / binlog 区别？
...
## 15. explain 关键字段？type / key / Extra？
