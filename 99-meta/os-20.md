...
1. [进程 vs 线程？协程？](#1-进程-vs-线程协程)
2. [虚拟内存原理？](#2-虚拟内存原理)
3. [page fault 类型和处理？](#3-page-fault-类型和处理)
4. [select / poll / epoll 区别？](#4-select--poll--epoll-区别)
5. [Reactor / Proactor 模型？](#5-reactor--proactor-模型)
6. [零拷贝原理？sendfile / mmap / splice？](#6-零拷贝原理sendfile--mmap--splice)
7. [线程同步原语？](#7-线程同步原语)
8. [死锁四个必要条件？怎么避免？](#8-死锁四个必要条件怎么避免)
9. [CPU 调度策略？CFS 是什么？](#9-cpu-调度策略cfs-是什么)
10. [上下文切换开销和优化？](#10-上下文切换开销和优化)
11. [TCP 三次握手 + 四次挥手？](#11-tcp-三次握手--四次挥手)
12. [TIME_WAIT 大量怎么办？](#12-time_wait-大量怎么办)
13. [TCP 拥塞控制？BBR 是什么？](#13-tcp-拥塞控制bbr-是什么)
14. [文件系统 inode / dentry / page cache？](#14-文件系统-inode--dentry--page-cache)
15. [线上 CPU 100% 怎么排查？](#15-线上-cpu-100-怎么排查)
16. [线上内存暴涨 / OOM 怎么排查？](#16-线上内存暴涨--oom-怎么排查)
17. [load average 高怎么排查？](#17-load-average-高怎么排查)
18. [磁盘 IO 高怎么排查？](#18-磁盘-io-高怎么排查)
19. [网络抖动 / 丢包怎么排查？](#19-网络抖动--丢包怎么排查)
20. [Linux 性能工具速查？](#20-linux-性能工具速查)
