...
1. [CDN 解决什么问题？三层架构？](#1-cdn-解决什么问题三层架构)
2. [CDN 命中率怎么算？怎么优化？](#2-cdn-命中率怎么算怎么优化)
3. [强缓存 vs 协商缓存？ETag vs Last-Modified？](#3-强缓存-vs-协商缓存etag-vs-last-modified)
4. [缓存键怎么设计？为什么默认含 query 危险？](#4-缓存键怎么设计为什么默认含-query-危险)
5. [Stale-While-Revalidate 解决什么？](#5-stale-while-revalidate-解决什么)
6. [GSLB 调度的判断维度？LDNS 不准怎么办？](#6-gslb-调度的判断维度ldns-不准怎么办)
7. [HTTP DNS 解决什么？](#7-http-dns-解决什么)
8. [Anycast 是什么？](#8-anycast-是什么)
9. [回源风暴怎么防？](#9-回源风暴怎么防)
10. [HTTP/2 vs HTTP/1.1 核心区别？](#10-http2-vs-http11-核心区别)
11. [HTTP/3 解决什么？QUIC 三大优势？](#11-http3-解决什么quic-三大优势)
12. [TLS 1.3 vs 1.2？0-RTT 风险？](#12-tls-13-vs-120-rtt-风险)
13. [DDoS 攻击类型和防护？](#13-ddos-攻击类型和防护)
14. [防盗链方案有哪些？签名 URL 怎么实现？](#14-防盗链方案有哪些签名-url-怎么实现)
15. [HSTS 是什么？](#15-hsts-是什么)
16. [边缘计算解决什么？V8 Isolate 优势？](#16-边缘计算解决什么v8-isolate-优势)
17. [HLS / DASH / WebRTC 怎么选？](#17-hls--dash--webrtc-怎么选)
18. [API 能上 CDN 吗？动态加速原理？](#18-api-能上-cdn-吗动态加速原理)
19. [大文件 + P2P 加速怎么做？](#19-大文件--p2p-加速怎么做)
20. [命中率骤降怎么排查？](#20-命中率骤降怎么排查)
