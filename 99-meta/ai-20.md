...
1. [LLM 怎么工作的？Transformer 是什么？](#1-llm-怎么工作的transformer-是什么)
2. [GPT vs BERT vs Llama？](#2-gpt-vs-bert-vs-llama)
3. [上下文窗口是什么？为什么有限？](#3-上下文窗口是什么为什么有限)
4. [Token 是什么？为什么按 Token 计费？](#4-token-是什么为什么按-token-计费)
5. [Prompt Engineering 关键技巧？](#5-prompt-engineering-关键技巧)
6. [RAG 是什么？怎么实现？](#6-rag-是什么怎么实现)
7. [向量数据库怎么选？](#7-向量数据库怎么选)
8. [Function Calling / Tool Use 怎么用？](#8-function-calling--tool-use-怎么用)
9. [Agent 是什么？ReAct 框架？](#9-agent-是什么react-框架)
10. [Claude Code / Cursor / Aider 对比？](#10-claude-code--cursor--aider-对比)
11. [MCP 是什么？解决什么？](#11-mcp-是什么解决什么)
12. [Skills 是什么？怎么用？](#12-skills-是什么怎么用)
13. [LangChain / LlamaIndex / LangGraph？](#13-langchain--llamaindex--langgraph)
14. [LLM 幻觉怎么防？](#14-llm-幻觉怎么防)
15. [Prompt 注入攻击怎么防？](#15-prompt-注入攻击怎么防)
16. [LLM 工程化关键问题？](#16-llm-工程化关键问题)
17. [AI 时代后端开发怎么变？](#17-ai-时代后端开发怎么变)
18. [Agent 怎么落地业务？](#18-agent-怎么落地业务)
19. [LLM 评测怎么做？](#19-llm-评测怎么做)
20. [AI 项目的成本怎么控制？](#20-ai-项目的成本怎么控制)
