...
1. [架构演进路径？什么时候该上微服务？](#1-架构演进路径什么时候该上微服务)
2. [康威定律是什么？怎么应用？](#2-康威定律是什么怎么应用)
3. [SLA / SLO / SLI 区别？Error Budget 是什么？](#3-sla--slo--sli-区别error-budget-是什么)
4. [4 个 9 怎么做到？要付出什么代价？](#4-4-个-9-怎么做到要付出什么代价)
5. [同城双活 vs 异地多活？单元化是什么？](#5-同城双活-vs-异地多活单元化是什么)
6. [降级 vs 熔断的区别？](#6-降级-vs-熔断的区别)
7. [灰度发布有哪些方案？](#7-灰度发布有哪些方案)
8. [混沌工程做什么？](#8-混沌工程做什么)
9. [性能优化的优先级和方法论？](#9-性能优化的优先级和方法论)
10. [缓存三大问题和解法？](#10-缓存三大问题和解法)
11. [异步化的好处和代价？](#11-异步化的好处和代价)
12. [False Sharing 是什么？怎么解？](#12-false-sharing-是什么怎么解)
13. [可扩展性的三个维度？](#13-可扩展性的三个维度)
14. [无状态化怎么做？](#14-无状态化怎么做)
15. [分库分表 vs NoSQL vs NewSQL？](#15-分库分表-vs-nosql-vs-newsql)
16. [一致性 Hash 解决什么？](#16-一致性-hash-解决什么)
17. [系统容量怎么评估？](#17-系统容量怎么评估)
18. [全链路压测怎么做？影子表是什么？](#18-全链路压测怎么做影子表是什么)
19. [ADR 是什么？怎么做技术选型？](#19-adr-是什么怎么做技术选型)
20. [架构师 vs 资深工程师区别？](#20-架构师-vs-资深工程师区别)
