...
1. [Redis 为什么快？](#q1)
2. [Redis 单线程模型？6.0 多线程？](#q2)
3. [String 底层 SDS 怎么实现？](#q3)
4. [List / Hash / ZSet 底层结构？](#q4)
5. [跳表 vs 红黑树？为什么 ZSet 用跳表？](#q5)
6. [RDB vs AOF？](#q6)
7. [fork + COW 怎么工作？](#q7)
8. [主从复制流程？全量 vs 增量？](#q8)
9. [哨兵 vs Cluster 区别？](#q9)
10. [Redis Cluster 16384 槽位为什么？](#q10)
11. [缓存穿透 / 击穿 / 雪崩怎么解？](#q11)
12. [Cache-Aside 一致性怎么保？](#q12)
13. [Redis 分布式锁（SETNX + Redlock）？](#q13)
14. [Redlock 真的安全吗？](#q14)
15. [淘汰 8 策略？怎么选？](#q15)
16. [大 Key / 热 Key 怎么解决？](#q16)
17. [BigKey 删除为什么阻塞？](#q17)
18. [Redis 实现限流？](#q18)
19. [Redis 实现排行榜 / 计数器 / 去重？](#q19)
20. [Redis 慢查询排查？](#q20)

---

## <a id="q1"></a>1. Redis 为什么快？
...
## <a id="q2"></a>2. Redis 单线程模型？6.0 多线程？
...
## <a id="q3"></a>3. String 底层 SDS 怎么实现？
...
## <a id="q4"></a>4. List / Hash / ZSet 底层结构？
...
## <a id="q5"></a>5. 跳表 vs 红黑树？为什么 ZSet 用跳表？
...
## <a id="q10"></a>10. Redis Cluster 16384 槽位为什么？
...
## <a id="q12"></a>12. Cache-Aside 一致性怎么保？
...
## <a id="q13"></a>13. Redis 分布式锁（SETNX + Redlock）？
...
## <a id="q16"></a>16. 大 Key / 热 Key 怎么解决？
...
## <a id="q19"></a>19. Redis 实现排行榜 / 计数器 / 去重？
