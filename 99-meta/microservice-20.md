...
1. [微服务 vs SOA 区别？](#1-微服务-vs-soa-区别)
2. [12-Factor 是什么？](#2-12-factor-是什么)
3. [什么时候该上微服务？真实代价？](#3-什么时候该上微服务真实代价)
4. [注册中心怎么选？](#4-注册中心怎么选)
5. [服务发现该 CP 还是 AP？](#5-服务发现该-cp-还是-ap)
6. [客户端发现 vs 服务端发现？](#6-客户端发现-vs-服务端发现)
7. [优雅下线怎么做？](#7-优雅下线怎么做)
8. [配置中心解决什么？长轮询原理？](#8-配置中心解决什么长轮询原理)
9. [灰度配置怎么做？](#9-灰度配置怎么做)
10. [API 网关解决什么？BFF 是什么？](#10-api-网关解决什么bff-是什么)
11. [Kong vs APISIX vs Envoy？](#11-kong-vs-apisix-vs-envoy)
12. [网关怎么防绕过？](#12-网关怎么防绕过)
13. [RPC vs HTTP？gRPC 比 JSON 快多少？](#13-rpc-vs-httpgrpc-比-json-快多少)
14. [Protobuf 兼容性铁律？](#14-protobuf-兼容性铁律)
15. [客户端 LB 算法？P2C 是什么？](#15-客户端-lb-算法p2c-是什么)
16. [Service Mesh 解决什么？真实代价？](#16-service-mesh-解决什么真实代价)
17. [Sidecar 模式怎么工作？](#17-sidecar-模式怎么工作)
18. [可观测性三支柱？](#18-可观测性三支柱)
19. [OpenTelemetry 是什么？](#19-opentelemetry-是什么)
20. [trace_id 怎么全链路透传？](#20-trace_id-怎么全链路透传)
