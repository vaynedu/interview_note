...
| [real-world-scenarios.md](real-world-scenarios.md) | **高频实战场景题(10 题)**:秒杀 / 幂等 / 支付回调 / 拆桶 / 短码 / 分库分表 / Redis 三大 / MQ 三大 / 防雪崩 / 性能 10× ⭐⭐ — **双轨模板**:**故事版**(8-10 段口头主线,白板答题用)+ **九维度追问储备**(分布式一致性 / 服务治理 / 缓存 / 异步 / 限流 / 容灾 / 监控 / 压测 / 真实踩坑)+ **三段式收尾**(面试回答版 / 一句话核心 / 背诵版) |
