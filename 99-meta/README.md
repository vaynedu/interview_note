...
| [real-world-scenarios.md](real-world-scenarios.md) | **高频实战场景题(10 题)**:秒杀 / 幂等 / 支付回调 / 拆桶 / 短码 / 分库分表 / Redis 三大 / MQ 三大 / 防雪崩 / 性能 10× ⭐⭐ — 按九维度展开(分布式一致性 / 服务治理 / 缓存优化 / 异步消息 / 限流熔断 / 容灾 / 监控 / 压测 / 真实踩坑) |
