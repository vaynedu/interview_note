...
| 位数 | 容量 | 按 100 万/天生成可用多久 | 结论 |
| --- | --- | --- | --- |
| **5 位** | 62^5 ≈ 9.16 亿 | ≈ 2.5 年 | 太短,扩展性差 |
| **6 位** | 62^6 ≈ 568 亿 | ≈ 155 年 | 理论够用,但冗余偏小 |
| **7 位** | 62^7 ≈ 3.5 万亿 | ≈ 9600 年 | **推荐** |
| **8 位** | 62^8 ≈ 218 万亿 | 近乎无限 | 太长,牺牲"短"的体验 |

**为什么最终选 7 位**:

1. **容量下界**:要满足 `62^N ≥ 总码量 × 安全系数`
2. **体验上界**:短链太长就失去传播价值,通常希望控制在 7-8 位内
3. **增长冗余**:今天是 100 万/天,以后可能到 1000 万/天,还要预留多年容量
4. **安全冗余**:即使做了 XOR 扰动和乱序,也希望原始码空间足够大,防止枚举过于容易

> 所以面试里我会直接说:**6 位在当前量级也够用,但工程上更稳的是 7 位**——容量是万亿级,长度又还保持在"短链"可接受范围内,是体验、安全、扩展性的平衡点。
